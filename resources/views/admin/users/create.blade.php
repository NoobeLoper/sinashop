@component('admin.layouts.content', ['title' => 'ایجاد کاربر'])
    ...
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item"><a href="/admin/users">فهرست کاربران</a></li>
                ...
                <form class="form-horizontal" action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password_confirmation" class="form-control" id="inputPassword3" placeholder="پسورد را تکرار کنید">
                        </div>
