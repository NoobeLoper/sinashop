@component('admin.layouts.content' , ['title' => 'ثبت دسترسی'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.users.index') }}">فهرست کاربران</a></li>
                ...
                <form class="form-horizontal" action="{{ route('admin.users.permissions.store', $user->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" name="permissions[]" id="permissions" multiple>
