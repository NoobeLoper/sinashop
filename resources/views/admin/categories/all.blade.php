@component('admin.layouts.content' , ['title' => 'فهرست دسته بندی ها'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="/admin">پنل مدیریت</a></li>
        <li class="breadcrumb-item active">فهرست دسته بندی ها</li>
    @endslot
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools d-flex">
                        ...
                        <div class="btn-group-sm mr-1">
                            ...
                            @else
                                <a href="#" class="btn btn-dark diabled ml-1">ایجاد دسته بندی</a>
                            @endcan
                        </div>
                    </div>
                </div>
