@component('admin.layouts.content' , ['title' => 'ویرایش کد تخفیف'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.discounts.index') }}">فهرست تخفیف‌ها</a></li>
        <li class="breadcrumb-item active">  ویرایش کد تخفیف {{ $discount->code }}</li>
    @endslot
                ...
                <form class="form-horizontal" action="{{ route('admin.discounts.update' , $discount->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-4 control-label">کد تخفیف</label>
                        ...
                        <div class="form-group">
                            <label for="precent" class="col-sm-4 control-label">میزان تخفیف (درصد)</label>
